...
<body>
    ...
    <div>
        ...
        <input type="radio" name="rdogroup" value="1">administrator<br><br>
        <input type="radio" name="rdogroup" value="2" checked>User<br><br>
       
        สถานะการใช้งาน<br><br>
        <input type="radio" name="rdostatus" value="1" checked>ปกติ<br><br>
        <input type="radio" name="rdostatus" value="2">ระงับการใช้งาน<br><br>
